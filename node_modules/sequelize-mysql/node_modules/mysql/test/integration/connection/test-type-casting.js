...
var tests = [
	...
	{type: 'linestring', insertRaw: 'LINESTRING(POINT(1.2,-3.4),POINT(-5.6,10.23),POINT(0.2,0.7))', expect: [
		{x: 1.2, y: -3.4},
		{x: -5.6, y: 10.23},
		{x: 0.2, y: 0.7}
	], deep: true},
	{type: 'polygon', insertRaw: "GeomFromText('POLYGON((0 0,10 0,10 10,0 10,0 0),(5 5,7 5,7 7,5 7, 5 5))')", expect: [
		[
			{x: 0, y: 0},
			{x: 10, y: 0},
			{x: 10, y: 10},
	...
	{type: 'multipoint', insertRaw: "GeomFromText('MULTIPOINT(0 0, 20 20, 60 60)')", expect: [
		{x: 0, y: 0},
		{x: 20, y: 20},
		{x: 60, y: 60}
	], deep: true},
	{type: 'multilinestring', insertRaw: "GeomFromText('MULTILINESTRING((10 10, 20 20), (15 15, 30 15))')", expect: [
		[
			{x: 10, y: 10},
			{x: 20, y: 20}
		],
	...
	{type: 'multipolygon', insertRaw: "GeomFromText('MULTIPOLYGON(((0 0,10 0,10 10,0 10,0 0)),((5 5,7 5,7 7,5 7, 5 5)))')", expect: [
		[
			[
				{x: 0, y: 0},
				{x: 10, y: 0},
	...
	{type: 'geometrycollection', insertRaw: "GeomFromText('GEOMETRYCOLLECTION(POINT(10 10), POINT(30 30), LINESTRING(15 15, 20 20))')", expect: [
		{x: 10, y: 10},
		{x: 30, y: 30},
		[
			{x: 15, y: 15},
