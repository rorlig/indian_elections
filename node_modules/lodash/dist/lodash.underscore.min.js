...
(function () {
	function n(n, r, t) {
		t = (t || 0) - 1;
		for (var e = n ? n.length : 0; ++t < e;)if (n[t] === r) {
			return t;
		}
		return-1
	}
	...
	function r(n, r) {
		var t = n.m, e = r.m;
		if (t !== e) {
			if (t > e || typeof t == "undefined") {
				return 1;
			}
			if (t < e || typeof e == "undefined") {
				return-1
			}
		}
		return n.n - r.n
	...
	function f(n, r, t, e) {
		...
		for (var u = n ? n.length : 0, o = []; ++e < u;) {
			var i = n[e];
			if (i && typeof i == "object" && typeof i.length == "number" && (Vr(i) || y(i))) {
				r || (i = f(i, r, t));
				var a = -1, l = i.length, c = o.length;
	...
	function a(n, r, t, e) {
		...
		if (n === n && !(n && hr[typeof n] || r && hr[typeof r])) {
			return!1;
		}
		if (null == n || null == r) {
			return n === r;
		}
		var o = Br.call(n), i = Br.call(r);
		if (o != i) {
			return!1;
		}
		switch (o) {
		...
		if (i = o == ir, !i) {
			if (Ar.call(n, "__wrapped__") || r instanceof u) {
				return a(n.__wrapped__ || n, r.__wrapped__ || r, t, e);
			}
			if (o != cr) {
				return!1;
			}
			var o = n.constructor, f = r.constructor;
			if (o != f && !(j(o) && o instanceof o && j(f) && f instanceof f)) {
				return!1
			}
		}
		for (t || (t = []), e || (e = []), o = t.length; o--;)if (t[o] == n) {
			return e[o] == r;
		}
		var l = !0, c = 0;
	...
	function p(n, r, t, e, u, o) {
		var i = 1 & r, f = 2 & r, a = 4 & r, l = 8 & r, c = 16 & r, h = 32 & r, v = n;
		if (!f && !j(n)) {
			throw new TypeError;
		}
		if (c && !t.length && (r &= -17, c = t = !1), h && !e.length && (r &= -33, h = e = !1), !i || f || a || h || !(Ur.fastBind || Rr && c)) {
			y = function () {
				var g = arguments, m = i ? u : this;
	...
	function L(n, r, t) {
		...
		if (r = $r(0, r) || 0, true === t) {
			...
			x(t) && (h = t.leading, p = "maxWait"in t && ($r(r, t.maxWait) || 0), s = "trailing"in t ? t.trailing : s);
		}
		var v = function () {
			var t = r - (Or() - i);
		...
		return function () {
			if (e = arguments, i = Or(), f = this, l = s && (a || !h), false === p) {
				var t = h && !a;
			} else {
				u || h || (c = i);
				var y = p - (i - c);
	...
	var Z, nr = 0, rr = {}, tr = +new Date + "", er = /($^)/, ur = /['\n\r\t\u2028\u2029\\]/g, or = "[object Arguments]", ir = "[object Array]", fr = "[object Boolean]", ar = "[object Date]", lr = "[object Number]", cr = "[object Object]", pr = "[object RegExp]", sr = "[object String]", hr = {"boolean": !1, "function": !0, object: !0, number: !1, string: !1, undefined: !1}, vr = {"\\": "\\", "'": "'", "\n": "n", "\r": "r", "\t": "t", "\u2028": "u2028", "\u2029": "u2029"}, gr = hr[typeof window] && window || this, yr = hr[typeof exports] && exports && !exports.nodeType && exports, mr = hr[typeof module] && module && !module.nodeType && module, _r = mr && mr.exports === yr && yr, dr = hr[typeof global] && global;
	!dr || dr.global !== dr && dr.window !== dr || (gr = dr);
	var br = [], wr = Object.prototype, jr = gr._, xr = RegExp("^" + (wr.valueOf + "").replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/valueOf|for [^\]]+/g, ".+?") + "$"), Er = Math.ceil, Tr = Math.floor, Ar = wr.hasOwnProperty, Or = xr.test(Or = Date.now) && Or || function () {
		return+new Date
	}, Sr = br.push, Br = wr.toString, Nr = br.unshift, Rr = xr.test(Rr = Br.bind) && Rr, kr = xr.test(kr = Object.create) && kr, Fr = xr.test(Fr = Array.isArray) && Fr, qr = gr.isFinite, Dr = gr.isNaN, Mr = xr.test(Mr = Object.keys) && Mr, $r = Math.max, Ir = Math.min, Wr = Math.random, zr = br.slice, Cr = xr.test(gr.attachEvent), Pr = Rr && !/\n|true/.test(Rr + Cr);
	o.prototype = u.prototype;
	var Ur = {};
	!function () {
		var n = {0: 1, length: 1};
		Ur.fastBind = Rr && !Pr, Ur.spliceObjects = (br.splice.call(n, 0, 1), !n[0])
	}(1), u.templateSettings = {escape: /<%-([\s\S]+?)%>/g, evaluate: /<%([\s\S]+?)%>/g, interpolate: /<%=([\s\S]+?)%>/g, variable: ""}, kr || (s = function (n) {
		if (x(n)) {
			e.prototype = n;
			var r = new e;
			e.prototype = null
	...
	var Vr = Fr || function (n) {
		...
		return x(n) ? Mr(n) : []
	} : Gr, Jr = {"&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#x27;"}, Kr = b(Jr), Lr = RegExp("(" + Hr(Kr).join("|") + ")", "g"), Qr = RegExp("[" + Hr(Jr).join("") + "]", "g"), Xr = function (n, r) {
		var t;
		if (!n || !hr[typeof n]) {
			return n;
		}
		for (t in n)if (r(n[t], t, n) === rr) {
			break;
		}
		return n
	}, Yr = function (n, r) {
		...
		for (t in n)if (Ar.call(n, t) && r(n[t], t, n) === rr) {
			break;
		}
		return n
	};
	...
	u.after = function (n, r) {
		...
		for (var n = arguments, r = n.length; r--;)if (!j(n[r])) {
			throw new TypeError;
		}
		return function () {
	...
	}, u.countBy = Zr, u.debounce = L, u.defaults = _, u.defer = function (n) {
		if (!j(n)) {
			throw new TypeError;
		}
		...
		var r = arguments, t = r.length, e = -1, u = v(), o = n ? n.length : 0, i = [];
		n:for (; ++e < o;) {
			var f = n[e];
			if (0 > u(i, f)) {
				for (var a = t; --a;)if (0 > u(r[a], f)) {
					continue n;
				}
				i.push(f)
			}
		...
		var t = zr.call(arguments, 2), e = -1, u = typeof r == "function", o = n ? n.length : 0, i = Array(typeof o == "number" ? o : 0);
		return R(n, function (n) {
		...
		return Vr(n) ? zr.call(n) : n && typeof n.length == "number" ? F(n) : A(n)
	}, u.union = function () {
		...
		var e = n ? n.length : 0;
		for (typeof t == "number" && (e = (0 > t ? $r(0, e + t) : Ir(t, e - 1)) + 1); e--;)if (n[e] === r) {
			return e;
		}
		return-1
		...
		u.prototype[n] = function () {
			var n = this.__wrapped__;
			return r.apply(n, arguments), Ur.spliceObjects || 0 !== n.length || delete n[0], this
		}
	...
	}), typeof define == "function" && typeof define.amd == "object" && define.amd ? (gr._ = u, define(function () {
		return u
