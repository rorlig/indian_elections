var sw = require("../common/swagger.js");
var param = require("../common/paramTypes.js");
var url = require("url");
var swe = sw.errors;
...
exports.findById = {
	'spec': {
		...
		"method": "GET",
		"params" : [param.path("userId", "user of pet that needs to be fetched", "string")],
		"responseClass" : "User",
		"errorResponses" : [swe.invalid('id'), swe.notFound('politician')],
		"nickname" : "getPoliticianById"
	}
	,
	'action': function (req,res) {
		if (!req.params.politicianId) {
			throw swe.invalid('id'); }
		var id = parseInt(req.params.politicianId);
		var pet = petData.getPetById(politicianId);
